...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { PhotoController } from './Interface/PhotoController';
...
const models: TsoaRoute.Models = {
    ...
    "Photo": {
        ...
        "properties": {
            ...
            "queryString": {"dataType":"string","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/recipe/generateRecipe',
            ...(fetchMiddlewares<RequestHandler>(RecipeController)),
            ...(fetchMiddlewares<RequestHandler>(RecipeController.prototype.generateRecipe)),

            async function RecipeController_generateRecipe(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/photo/dishPhoto/:dishName',
            ...(fetchMiddlewares<RequestHandler>(PhotoController)),
            ...(fetchMiddlewares<RequestHandler>(PhotoController.prototype.getPhotoByDishName)),

            async function PhotoController_getPhotoByDishName(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
